...
class Player : public Unit, public GridObject<Player>
{
    ...
    public:
		...
		template <class T>
        void ApplySpellMod(uint32 spellId, SpellModOp op, T& basevalue, Spell* spell = NULL);
        ...
        bool isResurrectRequestedBy(uint64 guid) const { return m_resurrectGUID != 0 && m_resurrectGUID == guid; }
        ...
        bool IsValidGhoulResurrectRequest(uint64 guid)
        {
            return !(m_ghoulResurrectPlayerGUID == 0) && m_ghoulResurrectPlayerGUID == guid;
        }
        void GhoulResurrect();
        void SetGhoulResurrectGhoulGUID(uint64 guid) { m_ghoulResurrectGhoulGUID = guid; }
        uint64 GetGhoulResurrectGhoulGUID() { return m_ghoulResurrectGhoulGUID; }
        void RemoveGhoul();
		...
		float GetAverageItemLevel_battle();
    ...
    protected:
        ...
        */
        ...
        Player::ClientGUIDs m_itemSoulboundTradeable;
		...
		uint64 m_ghoulResurrectPlayerGUID;
        uint64 m_ghoulResurrectGhoulGUID;
        ...
        uint32 m_deathTimer;
		uint32 m_bunousTimer;
		uint32 m_hackTimer;
		bool m_hacktimerstart;

		uint32 m_bunousCounter;
		uint32 m_ghostTimer;
		uint32 m_ClearComboPoints;
