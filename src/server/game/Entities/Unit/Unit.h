...
class Unit : public WorldObject
{
    public:
        ...
        void SetChannelObjectGuid(uint64 guid) { SetUInt64Value(UNIT_FIELD_CHANNEL_OBJECT, guid); }
		...
		void  ModSpellCastOrDurationTime(SpellInfo const* spellProto, int32& castTime, Spell* spell = NULL, bool modDuration = false);
