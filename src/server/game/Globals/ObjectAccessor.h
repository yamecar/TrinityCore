...
class ObjectAccessor
{
    ...
    public:
		...
		static void RemoveAllPlayersHORDEBuffer();
		static void RemoveAllPlayersALLIANCEBuffer();

		static void applicantAllPlayers(uint32 team, uint64 guid);
		static void bosskillreword(uint64 guid);
