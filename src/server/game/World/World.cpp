...
void World::LoadConfigSettings(bool reload)
{
	...
	m_int_configs[CONFIG_BATTLEGROUND_MATCH_TYPE]               = sConfigMgr->GetIntDefault ("Battleground.martcType", 0);
	...
	m_bool_configs[CONFIG_BOSS_KILL_REWORD]							 = sConfigMgr->GetBoolDefault("Killbossreword.enable", true); // 보스리워드
