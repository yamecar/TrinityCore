    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->Id)
        {
			...
			case 4242:
				...
				break;
			case 11593:
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(4); // 10 seconds, wrong DBC data?
				break;
			case 41924:
			...
			case 30562:     // Legacy of the Mountain King (only usable in Karazhan)
				...
				break;
			case 48090:
				spellInfo->CategoryRecoveryTime =65000;
				break;
			case 29866: // Cast Fishing Net
                spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(140); // 6yd
                break;
			case 51673:
				spellInfo->Effects[EFFECT_0].BasePoints = 1399;
				break;
			case 16591: //자유의지 물약
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(30); // 30분, wrong DBC data?
				break;
			case 16595: //자유의지 물약
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(30); // 30분, wrong DBC data?
				break;
			case 18209:
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(576); // 12시간, wrong DBC data?
				break;
			case 51362:
				spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(134); // 50000yd
				break;
			//커스텀
			case 30164:
			case 30178:
			...
			case 30177:
			case 31040: 
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(9); // 5 seconds, wrong DBC data?
				spellInfo->CategoryEntry = sSpellCategoryStore.LookupEntry(1);
				spellInfo->CategoryRecoveryTime = 30000;
				spellInfo->RecoveryTime = 60000;
				spellInfo->Effects[EFFECT_0].BasePoints = 199;
				break;
			case 23733:
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(9); // 30 seconds, wrong DBC data?
				spellInfo->Effects[EFFECT_0].BasePoints = 199;
				spellInfo->Effects[EFFECT_1].BasePoints = 199;
				break;
			case 73581:
			case 74299:
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(9); // 30초, wrong DBC data?
				break;
			case 24865:
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(30); // 30분?
            ...
            case 18756: // Improved Succubus (Rank 3)
                ...
                break;
			case 21098: //아주어고스 빙결
				spellInfo->Effects[EFFECT_0].BasePoints = 12340;
				break;
			case 21097: // 마나폭풍
				spellInfo->Effects[EFFECT_0].BasePoints = 2345;
			//	spellInfo->Effects[EFFECT_1].BasePoints = 2345;
			//	spellInfo->Effects[EFFECT_2].BasePoints = 2345;
				break;
			case 21099: //냉기숨결
				spellInfo->Effects[EFFECT_0].BasePoints = 23340;
				break;
			case 24998: //주문력
				spellInfo->DurationEntry = sSpellDurationStore.LookupEntry(42); // 30분?
				spellInfo->Effects[EFFECT_0].BasePoints = 399;
				spellInfo->Effects[EFFECT_1].BasePoints = 399;
				break;
			case 16612:
			case 17013:
			case 10767:
