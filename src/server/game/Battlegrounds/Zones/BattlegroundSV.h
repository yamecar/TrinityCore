...
const uint32 BG_SV_GraveyardIds[BG_SV_MAX_NODE_TYPES + 2] = {0, 0, 1742, 1744, 1741, 1740};
...
protected:
	BattlegroundSVScore(uint64 playerGuid) : BattlegroundScore(playerGuid), KillingPoints(0){ }

	void UpdateScore(uint32 type, uint32 value) override
	{
		switch (type)
		{
		case SCORE_KILL_POINTS:
			KillingPoints += value;
			break;
		default:
