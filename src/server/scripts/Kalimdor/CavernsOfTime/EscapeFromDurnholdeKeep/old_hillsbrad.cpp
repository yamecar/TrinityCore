...
//gossip items
#define GOSSIP_ITEM_SKARLOC1    "스랄. 테레사님은 당신을 만날수 없습니다."
#define GOSSIP_ITEM_SKARLOC2    "상황이 좀 복잡합니다. 스랄. 블랙무어와 부하들이 더 나타나기 전에 이제 산으로 출발하시는 것이 좋겠습니다. 우리가 테레사를 꼭 구하겠습니다."
#define GOSSIP_ITEM_TARREN      "우리는 준비가 되었습니다. 스랄."
#define GOSSIP_ITEM_WALKING     "이곳을 나갈 준비가 됐습니다. 스랄. 가시지요."
