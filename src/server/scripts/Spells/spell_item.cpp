...
public:
    ...
    class spell_item_death_choice_AuraScript : public AuraScript
    {
        ...
        {
			Unit* caster = eventInfo.GetActor();
			if (caster->ToPlayer()->HasSpellCooldown(SPELL_DEATH_CHOICE_NORMAL_STRENGTH) ||
				caster->ToPlayer()->HasSpellCooldown(SPELL_DEATH_CHOICE_NORMAL_AGILITY) ||
				caster->ToPlayer()->HasSpellCooldown(SPELL_DEATH_CHOICE_HEROIC_STRENGTH) ||
				caster->ToPlayer()->HasSpellCooldown(SPELL_DEATH_CHOICE_HEROIC_AGILITY))
				return false;
        ...
        void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
        {
            ...
            switch (aurEff->GetId())
            {
                case SPELL_DEATH_CHOICE_NORMAL_AURA:
                {
					...
					caster->ToPlayer()->AddSpellCooldown(SPELL_DEATH_CHOICE_NORMAL_STRENGTH, 0, time(NULL) + 45);
					caster->ToPlayer()->AddSpellCooldown(SPELL_DEATH_CHOICE_NORMAL_AGILITY, 0, time(NULL) + 45);
                    break;
                }
                case SPELL_DEATH_CHOICE_HEROIC_AURA:
                {
					...
					caster->ToPlayer()->AddSpellCooldown(SPELL_DEATH_CHOICE_HEROIC_STRENGTH, 0, time(NULL) + 45);
					caster->ToPlayer()->AddSpellCooldown(SPELL_DEATH_CHOICE_HEROIC_AGILITY, 0, time(NULL) + 45);
        ...
        void Register() override
        {
			DoCheckProc += AuraCheckProcFn(spell_item_death_choice_AuraScript::CheckProc);
...
public:
    ...
    class spell_item_darkmoon_card_greatness_AuraScript : public AuraScript
    {
        ...
        {
			Unit* caster = eventInfo.GetActor();
			if (caster->ToPlayer()->HasSpellCooldown(SPELL_DARKMOON_CARD_STRENGHT) ||
				caster->ToPlayer()->HasSpellCooldown(SPELL_DARKMOON_CARD_AGILITY) ||
				caster->ToPlayer()->HasSpellCooldown(SPELL_DARKMOON_CARD_INTELLECT) ||
				caster->ToPlayer()->HasSpellCooldown(SPELL_DARKMOON_CARD_SPIRIT))
				return false;
        ...
        void HandleProc(AuraEffect const* aurEff, ProcEventInfo& eventInfo)
        {
		   ...
		   caster->ToPlayer()->AddSpellCooldown(SPELL_DARKMOON_CARD_STRENGHT, 0, time(NULL) + 45);
		   caster->ToPlayer()->AddSpellCooldown(SPELL_DARKMOON_CARD_AGILITY, 0, time(NULL) + 45);
		   caster->ToPlayer()->AddSpellCooldown(SPELL_DARKMOON_CARD_INTELLECT, 0, time(NULL) + 45);
		   caster->ToPlayer()->AddSpellCooldown(SPELL_DARKMOON_CARD_SPIRIT, 0, time(NULL) + 45);
        }

        void Register() override
        {
			DoCheckProc += AuraCheckProcFn(spell_item_darkmoon_card_greatness_AuraScript::CheckProc);
