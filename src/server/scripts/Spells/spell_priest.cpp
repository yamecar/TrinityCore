...
class spell_pri_mind_vision : public SpellScriptLoader
{
    public:
        ...
        class spell_pri_mind_vision_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_pri_mind_vision_SpellScript);
            ...
            void Register() override
            {
                OnCheckCast += SpellCheckCastFn(spell_pri_mind_vision_SpellScript::CheckCast);
            }
        };

        SpellScript* GetSpellScript() const override
        {
            return new spell_pri_mind_vision_SpellScript;
        }
};
