...
{
    public:
        player_ghoulAI(Player* player, uint64 ghoulGUID) : PlayerAI(player), _ghoulGUID(ghoulGUID) { }
...
public:
    ...
    class spell_dk_raise_ally_SpellScript : public SpellScript
    {
        ...
        {
            Player* caster = GetCaster()->ToPlayer();
            Player* original = GetOriginalCaster()->ToPlayer();
            if (caster && original)
                original->GetSession()->SendNotification("구울로 부활하였습니다.");
        }
    ...
    private:
        ...
        void OnApply(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
        {
            ...
            if (!player || player->GetGhoulResurrectGhoulGUID() == 0)
                return;
        ...
        void OnRemove(AuraEffect const* /*aurEff*/, AuraEffectHandleModes /*mode*/)
        {
            ...
            player->SetGhoulResurrectGhoulGUID(0);
