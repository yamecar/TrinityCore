    ...
    public:
        ...
        struct boss_archmage_arugalAI : public BossAI
        {
            ...
            void EnterCombat(Unit* /*who*/) override
            {
                _EnterCombat();
                Talk(SAY_AGGRO);
                events.ScheduleEvent(EVENT_CURSE, 7000);
                events.ScheduleEvent(EVENT_TELEPORT, 15000);
                events.ScheduleEvent(EVENT_VOID_BOLT, 1000);
                events.ScheduleEvent(EVENT_THUNDERSHOCK, 10000);
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_THUNDERSHOCK:
							...
							events.ScheduleEvent(EVENT_THUNDERSHOCK, 30000);
                            break;
