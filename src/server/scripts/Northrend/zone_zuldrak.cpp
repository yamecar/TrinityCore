...
public:
    ...
    struct npc_quetzlun_worshipperAI : public ScriptedAI
    {
        npc_quetzlun_worshipperAI(Creature* creature) : ScriptedAI(creature) { }
		...
		void JustDied(Unit* killer) override
        {
			...
			if(me->HasAura(52222))
			{
				player->KilledMonsterCredit(28713, 0);
				DoCast(me,52242, true);
			}
        }
