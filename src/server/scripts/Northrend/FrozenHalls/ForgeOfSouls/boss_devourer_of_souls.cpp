    ...
    public:
        ...
        struct boss_devourer_of_soulsAI : public BossAI
        {
            ...
            void Reset() override
            {
				...
				me->ApplySpellImmune(SPELL_PHANTOM_BLAST, IMMUNITY_EFFECT, SPELL_EFFECT_INTERRUPT_CAST, false);
				me->ApplySpellImmune(H_SPELL_PHANTOM_BLAST, IMMUNITY_EFFECT, SPELL_EFFECT_INTERRUPT_CAST, false);
