...
{
    public:
        explicit PlagueStenchTargetSelector(Unit* caster) : _caster(caster) { }
...
class spell_stinky_plague_stench : public SpellScriptLoader
{
    public:
        ...
        class spell_stinky_plague_stench_SpellScript : public SpellScript
        {
            ...
            {
                targets.remove_if(PlagueStenchTargetSelector(GetCaster()));
            }

            void Register()
            {
                 OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(spell_stinky_plague_stench_SpellScript::FilterTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ENEMY);
            }
        };
