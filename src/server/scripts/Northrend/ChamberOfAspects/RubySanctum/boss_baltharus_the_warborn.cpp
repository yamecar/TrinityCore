    ...
    public:
        ...
        struct boss_baltharus_the_warbornAI : public BossAI
        {
            ...
            void JustSummoned(Creature* summon) override
            {
				...
				events.ScheduleEvent(EVENT_SUMMONS_ATTACK, 2000);
            }
    ...
    public:
        ...
        struct npc_baltharus_the_warborn_cloneAI : public BossAI
        {
            ...
            void EnterCombat(Unit* /*who*/) override
            {
                ...
                events.ScheduleEvent(EVENT_BLADE_TEMPEST, urand(18000, 25000));
                events.ScheduleEvent(EVENT_ENERVATING_BRAND, urand(10000, 15000));
            }
...
class spell_baltharus_enervating_brand : public SpellScriptLoader
{
    public:
        ...
        class spell_baltharus_enervating_brand_SpellScript : public SpellScript
        {
            PrepareSpellScript(spell_baltharus_enervating_brand_SpellScript);

			SpellCastResult CheckRequirement()
            {
				if (Unit* caster = GetCaster())
					if (Unit* target = GetExplTargetUnit())
						if (caster->GetDistance(target) > 12.0f)
            ...
            void Register() override
            {
                OnCheckCast += SpellCheckCastFn(spell_baltharus_enervating_brand_SpellScript::CheckRequirement);
            }
        };

        SpellScript* GetSpellScript() const override
        {
            return new spell_baltharus_enervating_brand_SpellScript();
        }
};
