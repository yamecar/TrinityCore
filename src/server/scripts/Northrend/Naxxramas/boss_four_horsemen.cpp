    ...
    public:
        Creature* getHorsemanHandle(Horseman who) const
        {
            if (_which == who)
                ...
                return ObjectAccessor::GetCreature(*me, instance->GetData64(who));
        }
    ...
    public:
        ...
        struct boss_four_horsemen_baronAI : public boss_four_horsemen_baseAI
        {
            ...
            void BeginFighting() override
            {
                ...
                events.ScheduleEvent(EVENT_UNHOLYSHADOW, urand(3000,7000));
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_UNHOLYSHADOW:
                            ...
                            events.ScheduleEvent(EVENT_UNHOLYSHADOW, urand(10000,30000));
                            break;
                    }
                }
    ...
    public:
        ...
        struct boss_four_horsemen_thaneAI : public boss_four_horsemen_baseAI
        {
            ...
            void BeginFighting() override
            {
	            ...
	            events.ScheduleEvent(EVENT_BERSERK, 10 * MINUTE * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_MARK, 24 * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_METEOR, urand(10000,15000));
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_METEOR:
                            ...
                            events.ScheduleEvent(EVENT_METEOR, urand(13000,17000));
                            break;
                    }
                }
    ...
    public:
        ...
        struct boss_four_horsemen_ladyAI : public boss_four_horsemen_baseAI
        {
            ...
            void BeginFighting() override
            {
                events.ScheduleEvent(EVENT_BERSERK, 10 * MINUTE * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_MARK, 24 * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_VOIDZONE, urand(5000,10000));
            }
				...
				while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_VOIDZONE:
                            ...
                            events.ScheduleEvent(EVENT_VOIDZONE, urand(12000, 18000));
                            break;
                    }
                }
    ...
    public:
        ...
        struct boss_four_horsemen_sirAI : public boss_four_horsemen_baseAI
        {
            ...
            void BeginFighting() override
            {
                events.ScheduleEvent(EVENT_BERSERK, 10 * MINUTE * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_MARK, 24 * IN_MILLISECONDS);
                events.ScheduleEvent(EVENT_HOLYWRATH, urand(13000,18000));
            }
                ...
                while (uint32 eventId = events.ExecuteEvent())
                {
                    switch (eventId)
                    {
                        ...
                        case EVENT_HOLYWRATH:
                            ...
                            events.ScheduleEvent(EVENT_HOLYWRATH, urand(10000,18000));
                            break;
                    }
                }
