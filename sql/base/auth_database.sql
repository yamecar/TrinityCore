...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/account' COMMENT='Account System';
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/account_access';
/*!40101 SET character_set_client = @saved_cs_client */
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/account_banned' COMMENT='Ban List';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `autobroadcast` (
  ...
  PRIMARY KEY (`id`,`realmid`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/autobroadcast';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ip2nation` (
  ...
  KEY `ip` (`ip`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/ip2nation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `ip2nationCountries` (
  ...
  PRIMARY KEY (`code`),
  KEY `code` (`code`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/ip2nationCountries';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/ip_banned' COMMENT='Banned IPs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/logs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `logs_ip_actions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/logs_ip_actions' COMMENT='Used to log ips of individual actions';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/rbac_account_permissions' COMMENT='Account-Permission relation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/rbac_default_permissions' COMMENT='Default permission to assign to different account security levels';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/rbac_linked_permissions' COMMENT='Permission - Linked Permission relation';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rbac_permissions` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/rbac_linked_permissions' COMMENT='Permission List';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `realmcharacters` (
  ...
  KEY `acctid` (`acctid`)
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/rbac_permissions' COMMENT='Realm Character Tracker';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=FEDERATED AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/realmlist' COMMENT='Realm System';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=FEDERATED DEFAULT CHARSET=utf8 CONNECTION='mysql://esotar:sys740115@222.96.170.157:3306/auth/uptime' COMMENT='Uptime system';
/*!40101 SET character_set_client = @saved_cs_client */;
